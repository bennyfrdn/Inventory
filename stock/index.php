                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a><i class="ti-user"></i><span style="color:#D3D4DB"style="color:#D3D4DB">Transaksi Peminjaman</span></a>

                             <ul class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i>

                                    <li><a href="masuk.php">Barang dikembalikan</a></li>
                                    <li><a href="keluar.php">Barang dipinjamkan</a></li>
            ...
            <?php 
                ...
                while($p=mysqli_fetch_array($periksa_bahan)){   
                    if($p['stock']<=1){ 
                        ...
                        <?php
                        echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['nama']. "</u> <u>".($p['serial_number'])."</u> &nbsp <u>".$p['stock']."</u></strong> yang tersisa sudah habis</div>";     
                    }
                }
                ?>
