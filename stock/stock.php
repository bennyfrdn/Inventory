...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set kode_barang='$kode_barang', nama='$nama', serial_number='$serial_number', stock='$stock', satuan='$satuan', lokasi='$lokasi', keterangan='$keterangan' where idx='$idx'");
			...
			<?php 
				...
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['stock']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['kode_barang']. "</u> <u>".($p['nama'])."</u> &nbsp <u>".$p['serial_number']."</u></strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Barang <?php echo $p['kode_barang']?> - <?php echo $p['nama']?> - <?php echo $p['serial_number']?></h4>
                                                            ...
                                                            <input type="text" id="kode_barang" name="kode_barang" class="form-control" value="<?php echo $p['kode_barang'] ?>">

                                                            <label for="nama">Nama Barang</label>
                                                            <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $p['nama'] ?>">

                                                            <label for="serial_number">Serial Number</label>
                                                            <input type="text" id="serial_number" name="serial_number" class="form-control" value="<?php echo $p['serial_number'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Barang <?php echo $p['kode_barang']?> - <?php echo $p['nama']?> - <?php echo $p['serial_number']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post">
								<div class="form-group">
									...
									<input name="kode_barang" type="text" class="form-control" placeholder="Kode Barang" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input name="serial_number" type="text" class="form-control" placeholder="SN">
								</div>
								<div class="form-group">
									<label>Stock</label>
